const translations = {
  ...
  es: {
    ...
    profile: 'Hola',
    profileText: 'Soy desarrollador de software, creando soluciones escalables y transformando sistemas heredados en arquitecturas modernas y limpias. Creo en los proyectos que evolucionan, se adaptan y mejoran con el tiempo. Lejos de la pantalla, a menudo me encontrarás en un sendero: el ciclismo enduro me entrena en la constancia y en la gestión de los imprevistos, cualidades que también llevo al desarrollo de software. ¿Te apetece una pausa? Intenta ganarme al tres en raya. 😉',
    location: 'San Giovanni Rotondo, Italia',
